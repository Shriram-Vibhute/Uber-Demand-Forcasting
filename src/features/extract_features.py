...
import joblib # Sklearn recommended
import pandas as pd
import logging
...
# Feature Engineering
def feature_encoder(df_reader, root_path):
...
# Model Training
def model_training(mini_batch_params, df_reader, scaler): # Doubt
...
def main():
    ...
    # train and save the standard scaler
    scaler = feature_encoder(df_reader, root_path)
    ...
    mini_batch = model_training(mini_batch_params, df_reader, scaler)
